# Indice Italiano — materiali per esame

Questo è il quadro generale di Italiano. Per studiare l'orale usa soprattutto l'indice interno:

> [italiano/italiano(appunti-studio-anno)/INDICE.md](<italiano/italiano(appunti-studio-anno)/INDICE.md>)

Lì i materiali sono riordinati secondo il **programma d'esame**, non secondo vecchie interrogazioni o ordine cronologico delle lezioni.
...
| Materiale | Link | Uso |
|---|---|---|
| Programma in Markdown | [programma/italiano.md](<programma/italiano.md>) | Checklist principale del programma |
| Programma in PDF | [Programma di Italiano per esame](<programma/Programma di Italiano per esame (2).pdf>) | Fonte ufficiale da conservare/controllare |
...
- [Italiano — indice programma d'esame](<italiano/italiano(appunti-studio-anno)/INDICE.md>)

Cartella principale:

- [italiano/italiano(appunti-studio-anno)](<italiano/italiano(appunti-studio-anno)>).

### Materiali completi già ordinati
...
| Pascoli | [mega-schema](<italiano/italiano(appunti-studio-anno)/pascoli/mega-schema.md>) | Pronto |
| D'Annunzio | [mega-schema](<italiano/italiano(appunti-studio-anno)/dannunzio/mega-schema.md>) | Pronto |
| Futurismo | [mega-schema](<italiano/italiano(appunti-studio-anno)/futurismo/mega-schema.md>) | Pronto |
| Romanzo del Novecento | [mega-schema](<italiano/italiano(appunti-studio-anno)/romanzo-novecento/mega-schema.md>) | Pronto |
| Svevo | [mega-schema](<italiano/italiano(appunti-studio-anno)/svevo/mega-schema.md>) | Pronto |
...
## Allenamento prima prova

Archivio prima prova:

- [italiano/prove_maturita_prima_prova/_INDICE.md](<italiano/prove_maturita_prima_prova/_INDICE.md>)
- [soluzioni/link esterni](<italiano/prove_maturita_prima_prova/_SOLUZIONI_LINKS.md>)

Uso consigliato:

1. Scegli una sessione ordinaria recente: 2025, 2024, 2023 o 2022.
2. Scrivi la prova prima di guardare soluzioni o svolgimenti.
3. Usa il quadro di riferimento per criteri e tipologie: [QDR prima prova 26 novembre](<italiano/prove_maturita_prima_prova/2019/quadro-riferimento/QDR prima PROVA 26 novembre.pdf>).

---

## Materiali di supporto

Questi materiali restano utili, ma non sono più il punto di partenza per studiare.

| Materiale | Link | Uso |
|---|---|---|
| Registro lezioni | [registro-lezioni.md](<italiano/italiano(appunti-studio-anno)/registro-lezioni.md>) | Controllo percorso fatto in classe |
| Lezioni trascritte | [lezioni](<italiano/italiano(appunti-studio-anno)/lezioni>) | Recupero dettagli specifici |
| Indice lezioni | [lezioni/INDICE.md](<italiano/italiano(appunti-studio-anno)/lezioni/INDICE.md>) | Navigazione delle lezioni |
| PDF riassunti interrogazioni maggio | [riassunti-interrogazioni-maggio.pdf](<italiano/italiano(appunti-studio-anno)/riassunti-interrogazioni-maggio.pdf>) | Vecchio ripasso rapido Futurismo → Saba |
| Materiali disordinati originali | [italiano/studio/disordinato(gioele)](<italiano/studio/disordinato(gioele)>) | Archivio sorgente; non studiare da qui se esiste già il mega-schema ordinato |
