...
```mermaid
flowchart TD
    A[Stabilizzazione 1924-29] --> B[Ripresa economica]
    A --> C[Coalizione centro-destra<br/>Hindenburg presidente]
    A --> D[Accordi di Locarno 1925<br/>Germania in SdN 1926]
    B --> E[Crollo di Wall Street<br/>Ottobre 1929]
    C --> F[Morte di Stresemann<br/>Ottobre 1929]
    D --> F
    E --> G[Grande Depressione]
    G --> H[Disoccupazione: 1,3 mln → 6 mln]
    H --> I[Consensi a partiti estremisti]
    I --> J[CRISI DI WEIMAR]
```
...
```mermaid
flowchart TD
    A[Programma hitleriano] --> B[Anticapitalismo]
    A --> C[Pangermanesimo]
    A --> D[Darwinismo sociale]
    A --> E[Antisemitismo]
    E --> F[Ebreo = nemico assoluto]
    E --> G[Complotto ebraico-comunista]
    C --> H[Comunità di popolo<br/>Razza ariana superiore]
    H --> I[Spazio vitale Lebensraum]
    D --> J[Gerarchia razziale:<br/>germanici > slavi/zigari/ebrei]
    F --> K[Estirpazione dalla comunità]
    G --> K
```
...
```mermaid
flowchart TD
    A[Crisi di Weimar 1929-30] --> B[Governi d'emergenza<br/>Brüning → von Papen → von Schleicher]
    B --> C[Elezioni settembre 1930<br/>NSDAP: 2,6% → 18,3%]
    C --> D[Elezioni luglio 1932<br/>NSDAP: 37,3%]
    D --> E[Elezioni novembre 1932<br/>NSDAP: 33,1%]
    E --> F[von Papen convince Hindenburg]
    F --> G[30 GENNAIO 1933:<br/>HITLER CANCELLIERE]
    H[Sinistra lacerata<br/>SPD vs KPD = socialfascisti] --> I[Nessun fronte comune<br/>contro il nazismo]
    I --> G
```
...
```mermaid
flowchart TD
    A[Hitler Cancelliere<br/>30 gen. 1933] --> B[Scioglimento Parlamento<br/>1° feb. 1933]
    B --> C[INCENDIO REICHSTAG<br/>28 feb. 1933]
    C --> D[Decreto emergenza:<br/>libertà sospese, censura, domicilio violabile]
    D --> E[Elezioni 5 marzo<br/>NSDAP: 43,9%]
    E --> F[LEGGE DEI PIENI POTERI<br/>23 marzo 1933]
    F --> G[444 sì, 94 no<br/>Comunisti esclusi]
    G --> H[DITTATURA LEGALIZZATA]
```
...
```mermaid
flowchart TD
    A[Politica della razza] --> B[Eliminazione «virus ebraico»]
    A --> C[~500.000 ebrei in Germania<br/>0,75% popolazione]
    B --> D[Boicottaggio uffici,<br/>negozi, medici ebrei]
    D --> E[Legge arianizzazione<br/>7 aprile 1933]
    E --> F[Estromissione ebrei<br/>dalla pubblica amministrazione]
    A --> G[Eugenetica forzata:<br/>sterilizzazione 400.000 persone]
    A --> H[Campi di concentramento<br/>Dachau 22 marzo 1933]
```
...
```mermaid
flowchart TD
    A[Politica economica nazista] --> B[Hjalmar Schacht<br/>Ministro Economia 1933-37]
    B --> C[Espansione spesa pubblica]
    C --> D[AUTOSTRADE<br/>Rete di trasporti]
    C --> E[MOTORIZZAZIONE<br/>Volkswagen di Porsche]
    A --> F[RIARMO<br/>Rinascita Wehrmacht 16 marzo 1935]
    D --> G[Riduzione disoccupazione]
    E --> G
    F --> G
    G --> H[CONSENSO DI MASSA]
```
...
```mermaid
flowchart TD
    A[COSTRUZIONE DEL CONSENSO NAZISTA] --> B[Pedagogia di massa]
    A --> C[Religione laica nazista]
    A --> D[Politica economica]
    A --> E[Repressione del dissenso]
    B --> B1[Organizzazioni per inquadrare<br/>il popolo e i giovani]
    B --> B2[Propaganda con cinema e radio]
    C --> C1[Adunate di massa<br/>film di Riefenstahl]
    C --> C2[Culto di Hitler e riti]
    D --> D1[Investimenti infrastrutture<br/>Autostrade, Volkswagen]
    D --> D2[Crescita industria bellica<br/>Calo disoccupazione]
    E --> E1[Roghi di libri<br/>10 maggio 1933]
    E --> E2[Arte e musica «degenerata»<br/>bandite]
```
...
```mermaid
flowchart TD
    A[Contesto internazionale favorevole] --> B[Paura del comunismo<br/>in Europa]
    A --> C[Divergenze Londra-Parigi]
    A --> D[Isolazionismo USA]
    A --> E[URSS: socialismo in un solo Paese]
    F[Germania 1933-39] --> G[Esce dalla SdN<br/>Ottobre 1933]
    G --> H[Riarmo]
    H --> I[Accordo navale con GB 1935]
    I --> J[Asse Roma-Berlino 1936]
    J --> K[Patto anti-Komintern<br/>con Giappone]
    K --> L[RECUPERO TERRITORI]
    L --> M[Saar 1935: plebiscito 90,9%]
    L --> N[Renania 7 marzo 1936]
```
...
```mermaid
flowchart TD
    A[Progetto grande Germania] --> B[Anschluss Austria<br/>11-12 marzo 1938]
    B --> C[Wehrmacht occupa<br/>senza resistenza]
    C --> D[Mussolini non interviene:<br/>intesa italo-tedesca + rapporti di forza]
    D --> E[Hitler proclama<br/>Anschluss da Vienna]
    E --> F[GB: linea conciliante<br/>autodeterminazione]
    E --> G[Francia: spera nelle<br/>promesse di pace]
...
mindmap
  root("**Cap. 3.11: La Germania nazista**")
    ("**1. Tramonto di Weimar<br/>e ascesa di Hitler**")
      ("Stabilizzazione 1924-29:<br/>Locarno, SdN, Stresemann")
      ("Rottura 1929: morte Stresemann,<br/>crollo Wall Street, 6 mln disoccupati")
      ("NSDAP: da 2,6% a 37,3%<br/>Hitler Führer dal 1921")
      ("Programma hitleriano:<br/>razzismo, antisemitismo, Lebensraum")
      ("Mein Kampf 1923<br/>SA camicie brune, SS Himmler")
    ("**2. Conquista del potere**")
      ("Hitler Cancelliere 30 gen. 1933")
      ("Incendio Reichstag 28 feb.<br/>Decreto emergenza")
      ("Legge pieni poteri 23 marzo")
      ("Partito unico luglio 1933<br/>Terzo Reich 12 novembre")
      ("Notte lunghi coltelli 30 giugno 1934<br/>SA eliminate, potere assoluto")
    ("**3. Natura del regime**")
      ("Comunità omogenea di sangue<br/>Nemico = la persona")
      ("Stato delle SS<br/>Campi concentramento Dachau")
      ("Leggi di Norimberga 1935<br/>Notte dei cristalli 1938")
      ("Culto di Hitler<br/>Gioventù hitleriana")
      ("Capitalismo compatibile<br/>con dittatura")
    ("**4. Politiche economiche<br/>e sociali**")
      ("Schacht: spesa pubblica,<br/>autostrade, Volkswagen")
      ("Riarmo dal 1935<br/>Wehrmacht")
      ("Riduzione disoccupazione<br/>Consenso di massa")
      ("Roghi di libri 1933<br/>Arte/musica degenerata")
      ("Religione politica<br/>Adunate Norimberga")
      ("Concordato con Santa Sede 1933")
    ("**5. Grande Germania**")
      ("Esce dalla SdN 1933<br/>Riarmo, Asse Roma-Berlino 1936")
      ("Saar 1935: 90,9% sì<br/>Renania 1936")
      ("Anschluss Austria<br/>11-12 marzo 1938")
      ("Contesto favorevole:<br/>paura comunismo, divergenze Londra-Parigi")
```
