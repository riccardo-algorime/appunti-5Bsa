...
```mermaid
flowchart LR
    A["Futurismo"] --> B["Romanzo del Novecento"]
    B --> C["Svevo"]
    B --> D["Pirandello"]
    C --> E["Crisi dell'io<br/>malattia, inettitudine, coscienza"]
    D --> F["Crisi dell'identità<br/>maschere, forma, relativismo"]
    E --> G["Ungaretti"]
    F --> G
    G --> H["Saba"]
    H --> I["Poesia novecentesca<br/>interiorità, trauma, verità"]
```
