...
flowchart TD
    ...
    B --> D["Rapporto conflittuale padre-figlio<br/>(riflesso autobiografico)"]
    B --> E["Esclusione dalla famiglia<br/>perché non più abile al lavoro"]
    D --> F["*Lettera al padre*:<br/>vocazione letteraria ostacolata"]

    C --> G["L'intellettuale che ha perduto<br/>il suo ruolo (cfr. Baudelaire)"]
