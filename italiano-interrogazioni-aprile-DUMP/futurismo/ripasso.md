...
```mermaid
flowchart LR
    M["Marinetti"] --> ZTT["Zang Tumb Tumb<br/>1914"]
    ZTT --> D1["Onomatopea della<br/>guerra d'Africa"]
    ZTT --> D2["Fonosimbolismo,<br/>calligrammi,<br/>segni algebrici"]
    G["Govoni"] --> RAR["Rarefazioni e<br/>parole in libertà<br/>1915"]
    RAR --> D3["Poesia visiva"]
    RAR --> PAL["Il palombaro:<br/>vita sottomarina<br/>tramite analogie"]

    style M fill:#e74c3c,stroke:#c0392b,color:#fff
    style G fill:#2980b9,stroke:#1f618d,color:#fff
```
