...
```mermaid
flowchart TD
    A[Morte di Lenin 1924] --> B[Lotta per la successione]
    B --> C[Stalin: socialismo in un solo Paese]
    B --> D[Trockij: rivoluzione permanente e industrializzazione]
    B --> E[Bucharin: difesa della NEP]
    C --> F[Stalin si impone 1929]
    F --> G[Fine NEP]
    G --> H[Collettivizzazione]
    H --> I[Dekulakizzazione<br/>deportazioni]
    H --> J[Carestia 1932-33<br/>Holodomor]
```
...
```mermaid
flowchart TD
    A[Progetto totalitario fascista] --> B[Organizzazioni di massa]
    B --> C[OND, ONB, GIL, GUF]
    A --> D[Intervento statale nell'economia]
    D --> E[IMI 1931<br/>IRI 1933]
    A --> F[Autarchia]
    F --> G[Autosufficienza in vista della guerra]
    A --> H[Fascistizzazione quotidiana]
    H --> I[Uomo nuovo fascista<br/>culto del DUCE]
    I --> J[Consenso, conformismo<br/>e disaffezione]
```
...
```mermaid
flowchart TD
    A[Politica razzista fascista] --> B[Razzismo coloniale]
    B --> C[Apartheid in Africa orientale]
    B --> D[Italianizzazione forzata<br/>popolazioni slave]
    A --> E[Antisemitismo 1937-38]
    E --> F[Manifesto degli scienziati razzisti]
    F --> G[Leggi razziste 17 novembre 1938]
    G --> H[Esclusione da scuola, Stato,<br/>PNF, professioni]
    G --> I[Censimento ebrei<br/>schedatura di polizia]
```
...
```mermaid
flowchart TD
    A[Spagna 1931: repubblica] --> B[Fronte popolare 1936]
    B --> C[Colpo di Stato militare<br/>luglio 1936]
    C --> D[Guerra civile]
    D --> E[Repubblicani<br/>URSS + Brigate internazionali]
    D --> F[Nazionalisti di Franco<br/>Italia + Germania]
    F --> G[Guernica 1937<br/>bombardamenti terroristici]
    E --> H[Resistenza antifascista]
    G --> I[Vittoria di Franco<br/>aprile 1939]
```
...
```mermaid
flowchart TD
    A[Anschluss Austria] --> B[Cecoslovacchia]
    B --> C[Sudeti]
    C --> D[Conferenza di Monaco<br/>settembre 1938]
    D --> E[Hitler ottiene i Sudeti]
    E --> F[Marzo 1939:<br/>invasione Cecoslovacchia]
    F --> G[Polonia nel mirino]
    G --> H[Patto Molotov-von Ribbentrop<br/>23 agosto 1939]
    H --> I[1° settembre 1939:<br/>invasione della Polonia]
    I --> J[Seconda guerra mondiale]
```
...
```mermaid
flowchart TD
    A[Revisionismo giapponese] --> B[Manciuria 1931]
    B --> C[Manchiukuò]
    C --> D[Giappone esce dalla SdN 1933]
    E[Cina frammentata] --> F[Kuomintang di Chiang]
    E --> G[Comunisti di Mao]
    G --> H[Lunga marcia 1934-35]
    F --> I[Repressione anticomunista]
    B --> J[Invasione della Cina 1937]
    J --> K[Massacro di Nanchino]
    J --> L[Grande sfera di coprosperità]
    L --> M[Asse Roma-Berlino-Tokyo]
```
...
```mermaid
flowchart TD
    A[Anni Trenta] --> B[Totalitarismi]
    A --> C[Revisionismi]
    B --> D[URSS staliniana]
    B --> E[Italia fascista]
    C --> F[Germania hitleriana]
    C --> G[Giappone imperiale]
    D --> H[Collettivizzazione<br/>Gulag<br/>Grande terrore]
    E --> I[Fascistizzazione<br/>Etiopia<br/>Leggi razziste]
    F --> J[Sudeti<br/>Cecoslovacchia<br/>Polonia]
    G --> K[Manciuria<br/>Cina<br/>Asse Tokyo]
    I --> L[Guerra di Spagna]
    F --> L
    L --> M[Laboratorio della guerra europea]
    J --> N[Seconda guerra mondiale]
    K --> N
```
