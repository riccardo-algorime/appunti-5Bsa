...
```mermaid
flowchart LR
    A[Alessandria d'Egitto<br/>1888, infanzia, Nilo, porto sepolto] --> B[Parigi<br/>Sorbona, Apollinaire, avanguardie, Lacerba]
    B --> C[Carso / Isonzo<br/>trincea, guerra, Allegria]
    C --> D[Roma<br/>fascismo, conversione religiosa]
    D --> E[Brasile<br/>insegnamento, morte del figlio]
    E --> F[Milano<br/>morte nel 1970, Vita d'un uomo]
```
...
mindmap
  root((Fasi di Ungaretti))
    ...
    Sentimento del tempo
      ...
      Endecasillabo
      Religiosità
      Lontananza dalla storia
    Il dolore
      Lutto privato
      Dolore collettivo
      Seconda guerra mondiale
      Monito contro l'odio
```
...
```mermaid
flowchart TD
    A[Ungaretti 1888-1970] --> B[Biografia per luoghi]
    B --> B1[Alessandria: nascita, Nilo, porto sepolto]
    B --> B2[Parigi: Sorbona, Apollinaire, Lacerba]
    B --> B3[Carso/Isonzo: trincea, guerra]
    B --> B4[Roma, Brasile, Milano]

    A --> C[Poetica]
    C --> C1[Porto sepolto = mistero]
    C --> C2[Parola essenziale]
    C --> C3[Segreto e impotenza della parola]
    C --> C4[Titolo verso zero, bianco = silenzio]

    A --> D[Fasi]
    D --> D1[Allegria: guerra e fratellanza]
    D --> D2[Sentimento del tempo: Ermetismo]
    D --> D3[Il dolore: lutto privato e collettivo]

    A --> E[Testi]
    E --> E1[Il porto sepolto]
    E --> E2[Veglia]
    E --> E3[Fratelli]
    E --> E4[I fiumi]
    E --> E5[Sono una creatura]
    E --> E6[San Martino del Carso]
    E --> E7[Non gridate più]
```
