...
flowchart TD
    ...
    B --> C[Estetismo<br/>Vita = opera d'arte]
    B --> D[Superomismo<br/>Poeta = Vate]
    B --> E[Panismo<br/>Fusione con la natura]
    ...
    G --> L[Oscar Wilde<br/>Andrea Sperelli = Dorian Gray]
    G --> M[Ungaretti<br/>Due visioni opposte della guerra]

    C -.->|ambivalenza| N[Fallimento dell'esteta<br/>Caducità e vanità]
```
