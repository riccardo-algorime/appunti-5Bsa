...
```mermaid
flowchart TD
    A["Umberto Saba<br/>Umberto Poli, 1883-1957"] --> B["Trieste<br/>confine, lingue, culture"]
    A --> C["Trauma familiare<br/>padre assente, madre severa, Peppa"]
    A --> D["Poesia onesta<br/>chiarezza e sincerità"]
    C --> E["Psicoanalisi<br/>Edoardo Weiss"]
