...
```mermaid
mindmap
  root((Roma città aperta))
    Personaggi
      Pina — Anna Magnani
        Donna del popolo
        Uccisa durante la retata
      Francesco
        Marxista, ideologo della Resistenza
      Don Pietro
        Sacerdote antifascista
    Temi
      Antifascismo trasversale
      Coraggio contro il regime
    Stile neorealista
      Luoghi reali di Roma
      Comparse = cittadini veri
      Caduta improvvisata di Magnani
```
...
```mermaid
flowchart LR
    A["<b>Verga</b><br/><i>I Malavoglia</i>"] -->|ispira| B["<b>Visconti</b><br/><i>La terra trema</i> (1948)"]
    A -->|modello letterario| C["<b>Calvino</b><br/>Prefazione al <i>Sentiero</i> (1964)"]
    D["<b>Rossellini</b><br/><i>Paisà</i> — ep. Inverno 1944"] -->|modello visivo| E["<b>Montaldo</b><br/><i>L'Agnese va a morire</i>"]
    F["<b>Renata Viganò</b><br/><i>L'Agnese va a morire</i>"] -->|romanzo adattato| E
    G["Cinema neorealista<br/>~1942-1951"] -->|modello per| H["Letteratura neorealista<br/>confini più sfumati"]
```
...
```mermaid
mindmap
  root((Neorealismo Cinematografico))
    Cronologia
      1942 — Ossessione, anticipazione
      1945-1948 — Cuore del movimento
      1951 — Miracolo a Milano, fine
    Tre registi
      Visconti
        Ossessione 1942
        La terra trema 1948
