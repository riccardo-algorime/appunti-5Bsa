...
```mermaid
flowchart TD
    A[GABRIELE D'ANNUNZIO<br/>1863-1938] --> B[POETICA COMPOSITA]
    B --> C[Estetismo<br/>Vita = opera d'arte<br/>Culto della bellezza]
    B --> D[Superomismo<br/>Poeta = Vate<br/>Impotenza → Onnipotenza]
    B --> E[Panismo<br/>Fusione con la natura<br/>Metamorfosi]
    B --> F[Vitalismo<br/>Esaltazione dei sensi<br/>Amoralità]
    
    A --> G[PRODUZIONE]
    G --> H[Poesia]
    G --> I[Romanzi]
    G --> J[Teatro]
    G --> K[Cinema e pubblicità]
    
    H --> L[Canto novo<br/>Canta la gioia]
    H --> M[Laudi / Alcyone<br/>La pioggia nel pineto<br/>Stabat nuda Aestas<br/>La sera fiesolana]
    H --> N[Notturno]
    
    I --> O[Il Piacere 1889<br/>Andrea Sperelli esteta]
    I --> P[Le Vergini delle Rocce<br/>Il Fuoco]
    
    A --> Q[VITA INIMITABILE]
    Q --> R[Roma barocca]
    Q --> S[Eleonora Duse]
    Q --> T[Imprese belliche<br/>Beffa di Buccari<br/>Volo su Vienna<br/>Fiume]
    Q --> U[Vittoriale degli Italiani]
    
    C -.->|ambivalenza| V[Fallimento dell'esteta<br/>Caducità, vanità]
```
