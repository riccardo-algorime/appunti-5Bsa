...
```mermaid
flowchart TD
    A[Positivismo] --> B[Naturalismo francese]
    A --> A1[Scienza, determinismo, metodo sperimentale]
    A --> A2[Limite: Freud e inconscio]
    B --> C[Flaubert: impersonalità]
    B --> D[De Goncourt: romanzo vero e clinica dell'amore]
    B --> E[Zola: romanzo sperimentale]
    B --> F[Taine: race, milieu, moment]
    B --> G[Verismo italiano]
    G --> H[Italia postunitaria e questione meridionale]
    G --> I[Verga]
    I --> L[Poetica: eclissi, regressione, straniamento]
    I --> M[Ciclo dei Vinti]
    M --> N[I Malavoglia]
    M --> O[Mastro-don Gesualdo]
    I --> P[Vita dei campi]
    P --> Q[Rosso Malpelo]
    P --> R[La lupa]
    P --> S[Fantasticheria]
    I --> T[Novelle rusticane: La roba]
    N --> U[La terra trema]
    I --> V[Pasolini e classi marginali]
```
