...
```mermaid
flowchart LR
    A["MANIFESTO DEL FUTURISMO<br/>Le Figaro, 20 feb 1909"] -->|Principi generali| B["Bellezza della velocità<br/>Guerra sola igiene del mondo<br/>Distruggere musei e biblioteche<br/>Solo l'aggressivo è capolavoro"]
    C["MANIFESTO TECNICO<br/>1912"] -->|Strumenti letterari| D["Paroliberismo<br/>Distruzione sintassi<br/>Verbo all'infinito<br/>No aggettivi/avverbi/punteggiatura<br/>Doppio sostantivo per analogia<br/>Immaginazione senza fili<br/>Maximum di disordine"]
```
...
mindmap
  root((FUTURISMO))
    COSA RIFIUTANO
      ...
      Musei, biblioteche, accademie
      Soggettività dell'io
      Sintassi, grammatica, punteggiatura
      Nietzsche e Superuomo greco
    COSA ESALTANO
      Modernità e macchina
      Velocità e dinamismo
      Guerra e aggressività
      Paroliberismo
      Immaginazione senza fili
      Simultaneità di percezioni
    CONCETTI CHIAVE
