...
## Schede complete programma da materiali disordinati

Queste schede non sono riassunti veloci: riordinano i materiali disordinati in file lunghi, testuali e studiabili. Servono come base completa; eventuali riassunti brevi vanno creati solo dopo.

| Scheda | Uso | Fonti principali |
|---|---|---|
| [Leopardi — ripasso programma](leopardi-ripasso-programma.md) | Studio completo di Classicismo/Romanticismo, Leopardi, *Zibaldone*, *Canti*, *Operette morali*, fase eroica e collegamenti orali | `ITA_FINAL_2.md`, `ITA2_finale.md` |
| [Pasolini — ripasso programma](pasolini-ripasso-programma.md) | Studio completo di vita, poesia friulana, romanzi romani, cinema, articoli corsari, interviste, morte e concetti sociali | `PASOLINI_Studio_Completo.md`, `APPUNTI-PASOLINI-MEGA.md` |
| [Positivismo, Naturalismo, Verismo e Verga — ripasso programma](positivismo-naturalismo-verismo-verga-ripasso-programma.md) | Studio completo di Positivismo, Naturalismo francese, Verismo italiano, Verga, tecniche narrative, opere e collegamenti | `APPUNTI-NATURALISMO-VERISMO-VERGA-MEGA.md`, `Naturalismo, Verismo e Giovanni Verga.md` |
