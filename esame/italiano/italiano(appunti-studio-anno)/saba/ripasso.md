...
```mermaid
flowchart LR
    A["Trieste<br/>confine"] --> B["Saba<br/>Umberto Poli"]
    B --> C["Trauma<br/>padre-madre-Peppa"]
    C --> D["Psicoanalisi<br/>Weiss"]
    B --> E["Poesia onesta"]
    E --> F["Chiarezza<br/>sincerità"]
    E --> G["Tradizione<br/>Canzoniere, sonetto"]
    E --> H["Modernità<br/>inconscio e dolore"]
    H --> I["La capra<br/>dolore universale"]
    H --> L["Amai<br/>verità al fondo"]
    E --> M["A mia moglie<br/>tenerezza e animali"]
    A --> N["Città vecchia<br/>umili"]
```
