...
```mermaid
graph TD
    A["🔺 TRIADE DEI MODELLI<br/>per la generazione neorealista"] --> B["<b>I Malavoglia</b><br/>Giovanni Verga"]
    A --> C["<b>Paesi tuoi</b> (1941)<br/>Cesare Pavese"]
    A --> D["<b>Conversazione in Sicilia</b> (1941)<br/>Elio Vittorini"]
    
    B --> E["Realtà umile, povera, misera<br/>Voce anonima / corale"]
    C --> F["Vita contadina piemontese<br/>Dimensione mitica e simbolica"]
    D --> G["Ritorno alle origini siciliane<br/>Realismo lirico"]
```
...
```mermaid
graph LR
    A["PIN"] --> B["Cerca il mondo<br/>degli ADULTI"]
    A --> C["Cerca i propri<br/>COETANEI"]
    B --> D["❌ Non può integrarsi<br/>per la giovane età"]
    C --> E["❌ Viene rifiutato<br/>perché maleducato e volgare"]
    D --> F["SOLITUDINE<br/>e ISOLAMENTO"]
    E --> F
    F --> G["La pistola diventa<br/>un OGGETTO MAGICO"]
    G --> H["Nascosta nel luogo<br/>dei nidi di ragno"]
```
...
```mermaid
graph LR
    A["TOGLIATTI<br/>Segretario PCI"] -->|"L'arte deve essere<br/>AL SERVIZIO della politica"| C["SCONTRO"]
    B["VITTORINI"] -->|"L'arte deve essere<br/>AUTONOMA"| C
    C --> D["L'arte NON deve<br/>'suonare il piffero<br/>della rivoluzione'"]
```
...
```mermaid
mindmap
  root((PAVESE<br/>Temi centrali))
    Città vs Campagna
      Torino = modernità, alienazione
      Langhe = radici, mito
    Terra natìa
      Ritorno alle origini
      Sradicamento
    Infanzia come età mitica
      Ricordo nostalgico
      Impossibilità del ritorno
    Collina
      Simbolo di isolamento
      Solitudine dell'intellettuale
    Resistenza come guerra civile
      Senso di colpa per la mancata partecipazione
      Compassione per il nemico
...
```mermaid
graph TD
    A["NEOREALISMO LETTERARIO<br/>'Non fu una scuola'<br/>(Calvino)"] --> B["REALISMO FIABESCO<br/><b>Calvino</b>"]
    A --> C["REALISMO LIRICO<br/><b>Vittorini</b>"]
    A --> D["REALISMO MITICO/SIMBOLICO<br/><b>Pavese</b>"]
    
    B --> B1["Realtà filtrata dallo sguardo<br/>infantile di Pin"]
    B --> B2["Oggetti reali trasfigurati<br/>in oggetti magici"]
    B --> B3["Sentiero, bosco, luogo segreto<br/>= topoi fiabeschi"]
    
    C --> C1["Narrazione idilliaca<br/>tra mito e storia"]
    C --> C2["Allitterazioni, ripetizioni,<br/>anafore → lirica"]
    C --> C3["Realtà utopistica e simbolica<br/>+ processo storico"]
    
    D --> D1["Elementi primordiali:<br/>sangue, terra, latte, fuoco"]
    D --> D2["Sacrificio rituale"]
    D --> D3["Collina come<br/>simbolo mitico"]
```
...
```mermaid
graph TD
    A["VERISMO<br/>(Verga, fine '800)"] -->|"Modello riconosciuto<br/>da Calvino nella triade"| B["NEOREALISMO<br/>(anni '40-'50)"]
    
    A --> C["Realtà umile e povera"]
    A --> D["Voce anonima/corale"]
    A --> E["Italia rurale e periferica"]
    A --> F["Lingua dialettale"]
    ...
    B --> G["+ Impegno politico<br/>esplicito (antifascismo)"]
    B --> H["+ Tema della Resistenza"]
    B --> I["+ Smania di comunicare<br/>l'esperienza vissuta"]
```
...
graph TB
    subgraph CONTESTO ["CONTESTO STORICO-CULTURALE"]
        WAR["Seconda Guerra Mondiale<br/>+ Resistenza (1943-45)"]
        ERM["Ermetismo anni '30<br/>(poesia elitaria, lontana dal reale)"]
        AMER["Apertura alla cultura americana<br/>(Vittorini + Pavese: <i>Americana</i>, 1941)"]
    end
    
    subgraph POETICA ["POETICA DEL NEOREALISMO"]
        SM["Smania di raccontare<br/>(Calvino, Pref. '64)"]
        NON["NON fu una scuola"]
        POP["Rapporto scrittore-popolo<br/>paritario"]
        ANTI["Antifascismo"]
        PERI["Italia periferica,<br/>rurale, regionale"]
    end
    
    subgraph TRIADE ["TRIADE DEI MODELLI"]
        VER["I Malavoglia<br/>(Verga)"]
        PAE["Paesi tuoi<br/>(Pavese, 1941)"]
        CON["Conversazione in Sicilia<br/>(Vittorini, 1941)"]
    end
    
    subgraph AUTORI ["AUTORI NEOREALISTI"]
        CAL["CALVINO<br/>Realismo fiabesco<br/><i>Il sentiero dei nidi di ragno</i> (1947)"]
        VIT["VITTORINI<br/>Realismo lirico<br/><i>Conversazione in Sicilia</i> (1941)"]
        PAV["PAVESE<br/>Realismo mitico<br/><i>Paesi tuoi</i>, <i>La casa in collina</i>,<br/><i>La luna e i falò</i>"]
        FEN["FENOGLIO<br/><i>Una questione privata</i>"]
        VIG["VIGANÒ<br/><i>L'Agnese va a morire</i> (1949)"]
    end
    
    WAR --> SM
    ERM -->|"reazione contro"| POP
    AMER --> PERI
