...
```mermaid
flowchart TD
    A[Educazione civica Italiano] --> B[Emancipazione femminile]
    A --> C[Donne nella Resistenza]
    A --> D[Memoria e rimozione]
    A --> E[Anni Sessanta e Settanta]

    B --> B1[Fascismo: angelo del focolare]
    B --> B2[1946: voto]
    B --> B3[1948: Costituzione, artt. 3, 37, 51]

    C --> C1[Staffette]
    C --> C2[Donne in armi]
    C --> C3[Testimonianze]
    C --> C4[Resistenza trasversale]

    C1 --> F[Tobagi: staffetta è termine riduttivo]
    C3 --> G[Ida D'Este: inventare, tacere, ricordare]
    C3 --> H[Ida Camanzi e Anna Berardi]
    C3 --> I[Testimonianza romagnola: argini, bici, Reno, Taglio Corelli, Lavezzola]

    D --> D1[Dopoguerra: ritorno alla casa]
    D --> D2[Partigiane giudicate e silenziate]
    D --> D3[Rivalutazione]

    E --> E1[1965 Cavani]
    E --> E2[1976 Montaldo]
    E --> E3[Archivio di Stato di Ravenna: '68 Lugo/Ravenna]
    E --> E4[Pasolini: contestazione, Palazzo, mutazione antropologica]

    C --> L[Viganò: L'Agnese va a morire]
    L --> L1[Agnese: donna popolare, materna, partigiana]
    L --> L2[Neorealismo letterario]
    L --> L3[Romagna e Resistenza dal basso]

    L --> M[Neorealismo]
    M --> M1[Rossellini: Paisà, Inverno 1944]
    M1 --> E2
```
