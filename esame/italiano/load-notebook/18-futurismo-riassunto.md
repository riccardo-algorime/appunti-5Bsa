...
```mermaid
flowchart TD
    A["Manifesto 1909"] --> B["Ideologia"]
    B --> C["Velocità"]
    B --> D["Guerra"]
    B --> E["Distruzione del passato"]
    B --> F["Aggressività"]

    G["Manifesto tecnico 1912"] --> H["Tecnica letteraria"]
    H --> I["Parole in libertà"]
    H --> J["Sintassi distrutta"]
    H --> K["Verbi all'infinito"]
    H --> L["Analogie e onomatopee"]
    H --> M["Tipografia espressiva"]
```
...
flowchart LR
    subgraph Rifiutano
      A[Passato]
      B[Musei e biblioteche]
      C[Scuola tradizionale]
      D[Io lirico]
      E[Sintassi e punteggiatura]
      F[Immobilità contemplativa]
    end
