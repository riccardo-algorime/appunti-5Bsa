...
flowchart LR
    ...
    B --> C["Riso: comico"]
    C --> D["Interviene la riflessione"]
    D --> E["Dolore nascosto"]
    E --> F["Sentimento del contrario"]
    F --> G["Umorismo: riso amaro + pietà"]
```
...
flowchart TD
    ...
    B --> C["Fuga a Monte Carlo"]
    C --> D["Vincita casuale"]
    D --> E["Legge la propria morte sul giornale"]
    E --> F["Nuova identità: Adriano Meis"]
    F --> G["Roma, pensione di Anselmo Paleari"]
    G --> H["Scopre che senza documenti non può vivere"]
    H --> I["Finto suicidio sul Tevere"]
    I --> L["Ritorno a Miragno"]
...
flowchart LR
    ...
    H --> I["Domanda: chi è più vero? uomo o personaggio?"]
```
